...
module "non_network_theat" {
  source               = "./modules/sumo_monitor"
  standard_name        = "Not a Network Threat"
  standard_description = "There was no suspicious network activity detected, please dont investigate."
